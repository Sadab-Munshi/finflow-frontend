...
export default function NotificationsPage() {
  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto bg-white min-h-screen sm:min-h-0">
                {/* ── Header ────────────────────────────────────────────── */}
          ...
          <div className="px-4 pb-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-100 rounded-xl text-sm text-slate-900 placeholder:text-slate-400 border-none outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all"
              />
            </div>
          </div>
        ...
        <AnimatePresence>
          {selectMode && filtered.length > 0 && (
            <motion.div
              ...
              className="overflow-hidden border-b border-slate-100 bg-blue-50/50"
            >
        ...
        {filtered.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center px-4 py-16">
            ...
            {searchQuery && (
              <button
                ...
                className="mt-4 px-4 py-2 rounded-full bg-blue-50 text-blue-600 text-xs font-semibold hover:bg-blue-100 transition-colors"
              >
                Clear search
              </button>
            )}
          ...
          <div className="divide-y divide-slate-50">
            {groupOrder.map(group => (
              <section key={group}>
                {/* Group header */}
                <div className="sticky top-[132px] z-10 bg-white/80 backdrop-blur-sm px-4 py-2 border-b border-slate-50">
                  ...
                  <AnimatePresence initial={false}>                    {grouped[group].map((notification, i) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`group flex items-start gap-3 px-4 py-3.5 cursor-pointer transition-colors hover:bg-slate-50/50 ${
        ...
        {hasMore && filtered.length >= PAGE_SIZE && (
          <div className="flex justify-center py-4 border-t border-slate-100">            <button
              ...
              className="px-5 py-2 rounded-full text-xs font-semibold text-blue-600 bg-blue-50 hover:bg-blue-100 transition-colors disabled:opacity-50"
            >
              {loadingMore ? (
              ...
              <div className="max-w-2xl mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-4 py-2 rounded-full text-xs font-semibold text-blue-600 bg-blue-50 hover:bg-blue-100 transition-colors"
                  >
                    Mark read
                  </button>
                  <button
