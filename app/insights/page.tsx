...
export default function InsightsPage() {
  ...
  const [cachedInsightsLoaded, setCachedInsightsLoaded] = useState(false)
  ...
  return (
    <Layout>
      ...
      <div className="space-y-3 px-4">
        ...
        {/* Inline loading indicator while regenerating (keeps existing insights visible) */}
        {dataLoading && (
        ...
        {/* Timestamp — always show if cached insights exist */}
        {savedTimestamp && (
        ...
        {insights.length > 0 ? (
          ...
          // Only show empty state after we've attempted to load cached insights and there's nothing cached
          cachedInsightsLoaded && !dataLoading && (
            <div
