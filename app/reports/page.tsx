      ...
      <div className="space-y-6">
        ...
        {reports.length === 0 ? (
          <div className="bg-white rounded-2xl p-8 text-center shadow-sm">
            ...
            <h3 className="font-semibold text-gray-800 mb-2">{t('noReports')}</h3>
            <p className="text-sm text-gray-500 leading-relaxed">
              {t('noReportsYetDesc').replace('{month}', nextMonthName).replace('{year}', String(nextYear))}
            </p>
          </div>
        ) : (
